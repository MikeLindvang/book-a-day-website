  ...
  return (
    <>
      ...
      <Main>
        ...
        <Paragraph>
          Welcome to Book-A-Day. If you continue to browse and use this website,
          ...
          Netscribepro's relationship with you in relation to this website. If
          you disagree with any part of these terms and conditions, please do
          not use our website.
        </Paragraph>
        <Paragraph>
          The term 'Book-A-Day' or 'Netscribepro' or 'us' or 'we' refers to the
          owner of the website whose registered office is , Dragebakken 96. Our
          company registration number is CVR: DK-37896691, place of
          registration: Denmark . The term 'you' refers to the user or viewer of
          our website.
        </Paragraph>
        <Paragraph>
