  ...
  return (
    <>
      ...
      <Main>
        ...
        <Paragraph>
          This privacy policy sets out how Netscribepro uses and protects any
          information that you give Netscribepro when you use this website.
        </Paragraph>

        <Paragraph>
          Netscribepro is committed to ensuring that your privacy is protected.
        ...
        <Paragraph>
          Netscribepro may change this policy from time to time by updating this
          page. You should check this page from time to time to ensure that you
          are happy with any changes. This policy is effective from Jan 27,
          2019.
        </Paragraph>
        ...
        <Heading level={2}>What we do with the information we gather</Heading>
        <Paragraph>
        ...
        <Paragraph>
          ...
          computer or any information about you, other than the data you choose
          to share with us.
        </Paragraph>
        <Paragraph>
        ...
        <Heading level={2}>Controlling your personal information</Heading>
        <Paragraph>
        ...
        <ul>
          <li>
            Whenever you are asked to fill in a form on the website, you give
            your consent that your information can be used by us for direct
            marketing purposes.
          </li>
          <li>
            If you have previously agreed to us using your personal information
            for direct marketing purposes, you may change your mind at any time
            by writing to or emailing us at mikehnielsen@netscribepro.com.
          </li>
        </ul>
        <Paragraph>
